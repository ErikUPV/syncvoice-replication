...
class VoxCPMModel(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        for i in range(B):
            ...
            curr_vid = self._resample_visuals(curr_vid.unsqueeze(0), n_audio_tokens, mode='nearest').squeeze(0)
    ...
    def _inference(
        ...
        if lip_feats is not None and face_feats is not None:
            ...
            visual_cond_seq = self._resample_visuals(visual_cond_seq, target_len=target_len, mode='nearest')
        ...
        if not training:
            ...
            for name, param in model.named_parameters():
                if "audio_vae" in name: # freeze VAE weights
                    ...
                    continue
                # for param in model.base_lm.parameters():
                #     param.requires_grad = False
